...
/**
 * Provides the local service interface for LeaveCategories. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see LeaveCategoriesLocalServiceUtil
...
public interface LeaveCategoriesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LeaveCategoriesLocalServiceUtil} to access the leave categories local service. Add custom service methods to {@link com.trianz.lms.service.impl.LeaveCategoriesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
