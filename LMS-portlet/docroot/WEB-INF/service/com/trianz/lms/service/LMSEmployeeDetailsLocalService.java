...
/**
 * Provides the local service interface for LMSEmployeeDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see LMSEmployeeDetailsLocalServiceUtil
...
public interface LMSEmployeeDetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LMSEmployeeDetailsLocalServiceUtil} to access the l m s employee details local service. Add custom service methods to {@link com.trianz.lms.service.impl.LMSEmployeeDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
