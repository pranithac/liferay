...
/**
 * Provides the local service interface for LMSLeavePolicies. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see LMSLeavePoliciesLocalServiceUtil
...
public interface LMSLeavePoliciesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LMSLeavePoliciesLocalServiceUtil} to access the l m s leave policies local service. Add custom service methods to {@link com.trianz.lms.service.impl.LMSLeavePoliciesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
