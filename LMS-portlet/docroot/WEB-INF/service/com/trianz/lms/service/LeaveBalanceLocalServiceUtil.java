 ...
 * {@link com.trianz.lms.service.impl.LeaveBalanceLocalServiceImpl} and is the
 ...
 * @see com.trianz.lms.service.impl.LeaveBalanceLocalServiceImpl
 * @generated
 */
public class LeaveBalanceLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.trianz.lms.service.impl.LeaveBalanceLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.trianz.lms.model.LeaveBalance addLeaveBalance(
	...
	*/
	public static com.trianz.lms.model.LeaveBalance createLeaveBalance(
		int EmployeeId) {
		return getService().createLeaveBalance(EmployeeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.trianz.lms.model.LeaveBalance deleteLeaveBalance(
		int EmployeeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteLeaveBalance(EmployeeId);
	}
	...
	*/
	...
	public static com.trianz.lms.model.LeaveBalance fetchLeaveBalance(
		int EmployeeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchLeaveBalance(EmployeeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.trianz.lms.model.LeaveBalance getLeaveBalance(
		int EmployeeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getLeaveBalance(EmployeeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.trianz.lms.model.LeaveBalance> getLeaveBalances(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.trianz.lms.model.LeaveBalance updateLeaveBalance(
		com.trianz.lms.model.LeaveBalance leaveBalance)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.trianz.lms.model.LeaveBalance getLeaveBalanceByEmpID(
		int EmployeeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getLeaveBalanceByEmpID(EmployeeId);
	}
	...
	public static LeaveBalanceLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					LeaveBalanceLocalService.class.getName());

			if (invokableLocalService instanceof LeaveBalanceLocalService) {
				_service = (LeaveBalanceLocalService)invokableLocalService;
			}
			else {
				_service = new LeaveBalanceLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(LeaveBalanceLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(LeaveBalanceLocalService service) {
	}

	private static LeaveBalanceLocalService _service;
}