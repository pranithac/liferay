...
/**
 * Provides the local service interface for LMSCompOffLeaveDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see LMSCompOffLeaveDetailsLocalServiceUtil
...
public interface LMSCompOffLeaveDetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LMSCompOffLeaveDetailsLocalServiceUtil} to access the l m s comp off leave details local service. Add custom service methods to {@link com.trianz.lms.service.impl.LMSCompOffLeaveDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
