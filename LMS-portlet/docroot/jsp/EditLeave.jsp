...
<portlet:param name="LeaveReqNo" value='<%=request.getParameter("LeaveRequestNo") %>'/>
</portlet:actionURL>
...
<aui:input type = "date" label="Start Date" name="startDate" id="startDate"  value='<%=request.getParameter("startDatetoSet") %>' readonly="true"></aui:input>
 
 <%}else{ %>
 <aui:input type = "date" label="Start Date" name="startDate" id="startDate"  onkeydown="return false;"  readonly="true"></aui:input>
 <%} %>
 </aui:column>
 <aui:column cssClass="span6">
<%if((request.getParameter("endDatetoSet"))!=null){ %>
<aui:input type = "date" label="End Date" name="endDate" id="endDate" onChange="getStartdate();" value='<%=request.getParameter("endDatetoSet") %>' readonly="true" ></aui:input>
 
 <%}else{ %>
 <aui:input type = "date" label="End Date" name="endDate" id="endDate" onChange="getStartdate();"  readonly="true"></aui:input>
 <%} %>
</aui:column>
...
<aui:input type="textarea" name="comments" value='<%=request.getParameter("comments") %>' maxlength="200" placeholder="Enter only 200 characters"/>

</aui:fieldset></div>
<aui:button-row>
<aui:button type="reset" name="cancel" value="Cancel" onClick="clearCalendar();"/>
<aui:button type="button" name="save" value="Save For Later" onClick="saveAsDraft();disableScreen();"/>
